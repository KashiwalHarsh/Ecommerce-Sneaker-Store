...
const Newsletter = () => {
  return (
    <>
    <svg xmlns="http://www.w3.org/2000/svg" class="wt-fill-denim-tint wt-width-full" viewBox="0 0 1280 30" preserveAspectRatio="xMidYMid slice" aria-hidden="true" focusable="false">
    ...
    <Container>
        ...
        <Desc>Get Timely updates from your favourite Products by Subscribing to our Newsletter</Desc>
        <InputContainer>
